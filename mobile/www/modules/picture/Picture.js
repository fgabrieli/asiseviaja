asi.Picture = {
  ...
  getPictures : function() {
   ...
   if (!t.isWaitingForPic) {
     ...
     console.log('asking for more pictures t.start=', t.start, ', end=', t.start + t.PICTURES_UNIT);
  ...
  ngController : function($scope) {
    ...
    Event.bind(asi.evt.gotPictures, 'PictureModule', function(pictures) {
      ...
      console.log(pictures.length, 'pictures received=', pictures);
